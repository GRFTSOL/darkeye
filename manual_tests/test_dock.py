import sys
from PySide6.QtWidgets import QApplication, QMainWindow, QLabel, QTextEdit, QCalendarWidget,QWidget,QVBoxLayout
...
class MyMainWindow(QWidget):
    def __init__(self):
        ...
        my_features = ads.CDockWidget.DockWidgetMovable | ads.CDockWidget.DockWidgetFocusable
        ...
        # 在第一个部件的下方添加第二个部件
        self.dock_manager.addDockWidget(ads.BottomDockWidgetArea, dock_2, dock_1.dockAreaWidget())
