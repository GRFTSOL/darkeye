...
from PySide6.QtCore import QSize,Qt,QPropertyAnimation, Property, QRectF, QPointF,QEasingCurve
...
class ShakeButton(QPushButton):
    ...
    def __init__(self,iconpath:str="arrow-up.png",iconsize=24,outsize=24,hoverable=True,color="#000000"):
        ...
        self._pixmap=QPixmap.fromImage(svg_to_qimage(str(ICONS_PATH / iconpath),iconsize,iconsize))
