...
下載程式並解壓，執行 exe 即可；瀏覽器擴充功能隨軟體附帶在 `extensions` 目錄內。若需刮削，請依下方文件安裝**對應瀏覽器的一種**外掛。
...
目前刮削對作品會盡力取得：發布時間、導演、中日文標題與劇情、女演員、男演員（若有）、標籤、封面、片長、製作商、廠牌、系列、劇照等。

對女演員資訊主要取得：頭像、生日、出道日、三圍、身高罩杯、曾用名（尚無曾用名更新機制；若初始使用曾用名可能導致資料問題）。
